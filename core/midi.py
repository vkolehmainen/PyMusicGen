...
class Midi():
    ...
    4. check which port it represents in pygame.midi by calling "" print(pygame.midi.get_device_info(X)) "" with different values
    5. set that as the output port of pygame.midi (in __init__)
